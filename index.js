...
<html>
    ...
    <body>
      ...
      <p><a href=https://demo.rajatrao.me/v1/account/verifyUserEmail?token=${token}&email=${email} >
        https://demo.rajatrao.me/v1/account/verifyUserEmail?token=${token}&email=${email} </a> </p>
        </body></html>
    </body>
</html>`;
